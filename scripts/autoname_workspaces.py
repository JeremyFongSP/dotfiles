...
WINDOW_ICONS_URXVT = {
    'urxvt-floating': fa.icons['terminal'],
    '~': fa.icons['terminal'],
    'python': fa.icons['code'],
    'nvim': fa.icons['code'],
}

WINDOW_ICONS_ZOOM = {
    'chat': fa.icons['comment'],
}

WINDOW_ICONS_FIREFOX = {
    'netflix': fa.icons['video'],
    'gmail': fa.icons['envelope'],
    'messenger': fa.icons['comment'],
    'youtube': fa.icons['youtube'],
    'sheets':fa.icons['table'],
    'space': fa.icons['rocket'],
    'colaboratory': fa.icons['code'],
}
...
def specific_window_name(window, classes):
    names = ['URxvt', 'zoom', 'firefox']
    for name in names:
        if name in classes:
            ...
            for cls in classes:
                for c in cls.split():
                    lowerc = c.lower()
                    if lowerc in WINDOW_ICONS_URXVT and name == 'URxvt':
                        return WINDOW_ICONS_URXVT[lowerc]
                    elif lowerc in WINDOW_ICONS_ZOOM and name == 'zoom':
                        return WINDOW_ICONS_ZOOM[lowerc]
                    elif lowerc in WINDOW_ICONS_FIREFOX and name == 'firefox':
                        return WINDOW_ICONS_FIREFOX[lowerc]
    else:
        return None
...
def icon_for_window(window):
    ...
    wm_name = specific_window_name(window, classes)
    print(wm_name)
    if wm_name:
        return wm_name
    else:
